...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Discussion":
			resolverName, err := entityResolverNameForDiscussion(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Discussion": %w`, err)
			}
			switch resolverName {
			...
			case "findDiscussionByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findDiscussionByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindDiscussionByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Discussion": %w`, err)
				}
...
func entityResolverNameForDiscussion(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findDiscussionByID", nil
	}
	return "", fmt.Errorf("%w for Discussion", ErrTypeNotFound)
}
