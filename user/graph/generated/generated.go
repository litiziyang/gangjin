...
type ComplexityRoot struct {
	...
	Mutation struct {
		Login       func(childComplexity int, phone string, password *string, code *string) int
		SendCode    func(childComplexity int, phone *string) int
		SetPassword func(childComplexity int, oldPassword string, newPassword string) int
	}
...
type MutationResolver interface {
	...
	Login(ctx context.Context, phone string, password *string, code *string) (*model.LoginResponse, error)
	SetPassword(ctx context.Context, oldPassword string, newPassword string) (string, error)
}
type QueryResolver interface {
	User(ctx context.Context, phone string) (*model.User, error)
}
type UserResolver interface {
	ID(ctx context.Context, obj *model.User) (int64, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.login":
		...
		return e.complexity.Mutation.Login(childComplexity, args["phone"].(string), args["password"].(*string), args["code"].(*string)), true
	...
	case "Mutation.sendCode":
		...
		return e.complexity.Mutation.SendCode(childComplexity, args["phone"].(*string)), true
	...
	case "Mutation.setPassword":
		...
		return e.complexity.Mutation.SetPassword(childComplexity, args["oldPassword"].(string), args["newPassword"].(string)), true
...
func (ec *executionContext) _Mutation_sendCode(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().SendCode(rctx, fc.Args["phone"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_login(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Login(rctx, fc.Args["phone"].(string), fc.Args["password"].(*string), fc.Args["code"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNloginResponse2ᚖuserᚋgraphᚋmodelᚐLoginResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_setPassword(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().SetPassword(rctx, fc.Args["oldPassword"].(string), fc.Args["newPassword"].(string))
		}
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.User)
	fc.Result = res
	return ec.marshalOUser2ᚖuserᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNloginResponse2userᚋgraphᚋmodelᚐLoginResponse(ctx context.Context, sel ast.SelectionSet, v model.LoginResponse) graphql.Marshaler {
	return ec._loginResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNloginResponse2ᚖuserᚋgraphᚋmodelᚐLoginResponse(ctx context.Context, sel ast.SelectionSet, v *model.LoginResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOUser2ᚖuserᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
